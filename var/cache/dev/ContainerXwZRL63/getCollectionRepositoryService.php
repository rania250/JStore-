 ...
 */
class getCollectionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CollectionRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CollectionRepository.php';

        return $container->privates['App\\Repository\\CollectionRepository'] = new \App\Repository\CollectionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
