 ...
 */
class getSlidersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SlidersRepository' shared autowired service.
     *
     * @return \App\Repository\SlidersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SlidersRepository.php';

        return $container->privates['App\\Repository\\SlidersRepository'] = new \App\Repository\SlidersRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
